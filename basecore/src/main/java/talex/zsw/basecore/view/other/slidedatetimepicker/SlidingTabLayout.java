 ...
 * <p>
 * The views used as tabs can be customized by calling {@link #setCustomTabView(int, int, int, int, boolean)},
...
public class SlidingTabLayout extends HorizontalScrollView
{
	 ...
	 */
	public void setCustomTabView(int layoutResId, int textViewId, int themeColor, int titleColor, boolean showTime)
	{
	 ...
	 * {@link #setCustomTabView(int, int, int, int, boolean)}.
	 */
		...
		for(int i = 0; i < adapter.getCount(); i++)
		{
			...
			if(mTabViewLayoutId != 0)
			{
				...
				if(mShowTime)
				{
					if(i == 0)
					{
						tabTitleView.setBackgroundResource(R.drawable.bg_black_tlc);
					}
					else
					{
						tabTitleView.setBackgroundResource(R.drawable.bg_black_trc);
					}
				}
				...
				if(mThemeColor != 0)
				{
					try
					{
						GradientDrawable background = (GradientDrawable) tabTitleView.getBackground();
						background.setColor(mThemeColor);
					}
