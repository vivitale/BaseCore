 ...
 * 亮度相关工具类
 */
public final class BrightnessTool
{
	...
	public static boolean isAutoBrightnessEnabled()
	{
		try
		{
			int mode = Settings.System.getInt(Tool
				                                  .getContext()
	...
	{
		if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && !Settings.System.canWrite(Tool.getContext()))
		{
		...
		return Settings.System.putInt(Tool.getContext().getContentResolver(), Settings.System.SCREEN_BRIGHTNESS_MODE,
	...
	public static int getBrightness()
	{
		try
		{
			return Settings.System.getInt(Tool.getContext().getContentResolver(), Settings.System.SCREEN_BRIGHTNESS);
		}
		catch(Settings.SettingNotFoundException e)
		{
			e.printStackTrace();
	...
	public static boolean setBrightness(@IntRange(from = 0, to = 255) final int brightness)
	{
		...
		ContentResolver resolver = Tool.getContext().getContentResolver();
	...
	public static void setWindowBrightness(
		@NonNull final Window window, @IntRange(from = 0, to = 255) final int brightness)
	{
