...
public class RegTool
{
	...
	@RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN_MR2) public static boolean isEmpty(final SparseLongArray obj)
	{
		return obj == null || obj.size() == 0;
	}
	...
	@RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN_MR2) public static boolean isNotEmpty(final SparseLongArray obj)
	{
		return !isEmpty(obj);
	}
	...
	{
		return isMatch(ConstTool.REGEX_MOBILE_SIMPLE, string);
	}
	...
	{
		return isMatch(ConstTool.REGEX_MOBILE_EXACT, string);
	}
	...
	{
		return isMatch(ConstTool.REGEX_TEL, string);
	}
	...
	{
		return isMatch(ConstTool.REGEX_IDCARD15, string);
	}
	...
	{
		return isMatch(ConstTool.REGEX_IDCARD18, string);
	}
	...
	{
		return isMatch(ConstTool.REGEX_EMAIL, string);
	}
	...
	{
		return isMatch(ConstTool.REGEX_URL, string);
	}
	...
	{
		return isMatch(ConstTool.REGEX_CHZ, string);
	}
	...
	{
		return isMatch(ConstTool.REGEX_USERNAME, string);
	}
	...
	{
		return isMatch(ConstTool.REGEX_DATE, string);
	}
	...
	{
		return isMatch(ConstTool.REGEX_IP, string);
	}
