...
public class TextTool
{
	...
	public static class Builder
	{
		...
		private int flag;
		@ColorInt private int foregroundColor;
		@ColorInt private int backgroundColor;
		@ColorInt private int quoteColor;
		...
		private void setSpan()
		{
			...
			if(imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId)
			{
				if(imageIsBitmap)
				{
					mBuilder.setSpan(new ImageSpan(Tool.getContext(), bitmap), start, end, flag);
					bitmap = null;
					imageIsBitmap = false;
				}
				...
				{
					mBuilder.setSpan(new ImageSpan(Tool.getContext(), uri), start, end, flag);
					uri = null;
					imageIsUri = false;
				}
				else
				{
					mBuilder.setSpan(new ImageSpan(Tool.getContext(), resourceId), start, end, flag);
					resourceId = 0;
