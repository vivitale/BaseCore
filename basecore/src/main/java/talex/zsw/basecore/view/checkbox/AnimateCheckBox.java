package talex.zsw.basecore.view.checkbox;
...
public class AnimateCheckBox extends View
{
	...
	public AnimateCheckBox(Context context, AttributeSet attrs, int defStyleAttr)
	{
		...
		correctWidth = a.getDimensionPixelSize(R.styleable.AnimateCheckBox_ACB_lineWidth, DEFAULT_LINE_WIDTH);
		animDuration = a.getInteger(R.styleable.AnimateCheckBox_ACB_animDuration, DEFAULT_ANIM_DURATION);
