package talex.zsw.basecore.view.other.swipetoloadlayout.footer;
...
import talex.zsw.basecore.view.other.swipetoloadlayout.SwipeLoadMoreTrigger;
import talex.zsw.basecore.view.other.swipetoloadlayout.SwipeTrigger;
import talex.zsw.basecore.view.other.swipetoloadlayout.drawable.google.RingProgressDrawable;


/**
 * Created by Aspsine on 2015/11/5.
 */
public class GoogleLoadMoreFooterView extends FrameLayout
	...
	public GoogleLoadMoreFooterView(Context context, AttributeSet attrs, int defStyleAttr)
	{
		...
		ringProgressDrawable
			.setColors(res.getColor(R.color.google_blue ), res.getColor(R.color.google_red ),
			           res.getColor( R.color.google_yellow ), res.getColor( R.color.google_green ) );
