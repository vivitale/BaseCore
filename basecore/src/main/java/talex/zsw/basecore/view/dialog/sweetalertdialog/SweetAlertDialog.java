...
public class SweetAlertDialog extends Dialog implements View.OnClickListener
{
	...
	public SweetAlertDialog(Context context, int alertType)
	{
		...
		mSuccessLayoutAnimSet
			= (AnimationSet) OptAnimationLoader.loadAnimation(getContext(), R.anim.sweetalert_success_mask_layout);
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		mDialog = (LinearLayout) findViewById(R.id.loading);
		mTitleTextView = (TextView) findViewById(R.id.title_text);
		mTitleTextView2 = (TextView) findViewById(R.id.title_text2);
	...
	private void changeAlertType(int alertType, boolean fromCreate)
	{
		...
		if(mDialogView != null)
		{
			...
			mDialog.setBackgroundResource(R.drawable.sweetalert_dialog_background);
			switch(mAlertType)
			{
				case ERROR_TYPE:
				...
				case CUSTOM_IMAGE_TYPE:
					...
					break;
				case PROGRESS_TYPE:
					mDialog.setBackgroundResource(R.color.transparent);
					mProgressFrame.setVisibility(View.VISIBLE);
					mConfirmButton.setVisibility(View.GONE);
					mTitleTextView.setVisibility(View.GONE);
					if(RegTool.isNullString(mTitleText))
					{
						mTitleTextView2.setVisibility(View.GONE);
					}
					else
					{
						mTitleTextView2.setVisibility(View.VISIBLE);
					}
					break;
			}
			if(!fromCreate)
	...
	public SweetAlertDialog setTitleText(String text)
	{
		...
		if(mTitleTextView2 != null && mTitleText != null)
		{
			mTitleTextView2.setText(mTitleText);
		}
		return this;
	}
