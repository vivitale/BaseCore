...
import static talex.zsw.basecore.util.DataTool.hexString2Bytes;
import static talex.zsw.basecore.util.DataTool.bytes2HexString;
...
public class EncryptTool
{
	...
	{
		return EncodeTool.base64Encode(encryptDES(data, key));
	}
	...
	{
		return EncodeTool.base64Encode(encrypt3DES(data, key));
	}
	...
	{
		return EncodeTool.base64Encode(encryptAES(data, key));
	}
