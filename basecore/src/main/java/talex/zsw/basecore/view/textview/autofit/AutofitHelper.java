package talex.zsw.basecore.view.textview.autofit;
...
public class AutofitHelper
{
	 ...
	 */
	@TargetApi(Build.VERSION_CODES.HONEYCOMB) public AutofitHelper setEnabled(boolean enabled)
	{
		if (mEnabled != enabled)
		{
			mEnabled = enabled;
	...
	@TargetApi(Build.VERSION_CODES.HONEYCOMB) private class AutofitOnLayoutChangeListener
