...
import talex.zsw.basecore.view.other.swipetoloadlayout.drawable.yalantis.BaseRefreshDrawable;
import talex.zsw.basecore.view.other.swipetoloadlayout.drawable.yalantis.SunRefreshDrawable;
...
public class YalantisPhoenixRefreshHeaderView extends FrameLayout implements SwipeTrigger, SwipeRefreshTrigger
{
	...
	@Override protected void onFinishInflate()
	{
		...
		mDrawable = new SunRefreshDrawable(getContext(), this, mTriggerOffset, DeviceTool.getScreenWidth(getContext()));
