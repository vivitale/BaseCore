package talex.zsw.basecore.view.other.flowlayout;
...
public class TagFlowLayout extends FlowLayout implements TagAdapter.OnDataChangedListener
{
	...
	public TagFlowLayout(Context context, AttributeSet attrs, int defStyle)
	{
		...
		mAutoSelectEffect = ta.getBoolean(R.styleable.FlowLayout_FL_auto_select_effect, true);
		mSelectedMax = ta.getInt(R.styleable.FlowLayout_FL_max_select, -1);
		ta.recycle();
	...
	public void setMaxSelectCount(int count)
	{
		...
		{
			LogTool.w(TAG, "you has already select more than "+count+" views , so it will be clear .");
			mSelectedView.clear();
		}
		mSelectedMax = count;
	}
